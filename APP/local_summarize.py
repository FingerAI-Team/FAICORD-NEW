...
with open('./dataset/stt/faicord_250721_ai_meeting.json', 'r', encoding='utf-8') as f:
...
messages = [
    ...
    {
        "role": "user",
        "content": "다음 녹취록을 위 지침에 따라 요약해 마크다운으로 작성해 주세요.\n\n```json\n"
...
summary = generated.split("<|start_header_id|>assistant<|end_header_id|>")[-1].strip()
print(summary)